...
# %bb.8:                                # %init_array.exit
	...
	movl	$1, %eax
	vbroadcastsd	.LCPI0_15(%rip), %zmm2  # zmm2 = [1.2E+0,1.2E+0,1.2E+0,1.2E+0,1.2E+0,1.2E+0,1.2E+0,1.2E+0]
	xorl	%ecx, %ecx
	vbroadcastsd	.LCPI0_16(%rip), %zmm3  # zmm3 = [1.5E+0,1.5E+0,1.5E+0,1.5E+0,1.5E+0,1.5E+0,1.5E+0,1.5E+0]
	vmovdqa	.LCPI0_0(%rip), %ymm4           # ymm4 = [0,1,2,3,4,5,6,7]
	vmovdqa	.LCPI0_12(%rip), %ymm5          # ymm5 = [8,9,10,11,12,13,14,15]
	vmovdqa	.LCPI0_13(%rip), %ymm6          # ymm6 = [16,17,18,19,20,21,22,23]
	vmovdqa	.LCPI0_14(%rip), %ymm7          # ymm7 = [24,25,26,27,28,29,30,31]
	movq	%rbx, %rdx
	jmp	.LBB0_10
	.p2align	4, 0x90
.LBB0_9:                                # %.loopexit.i
...
.LBB0_13:                               #   in Loop: Header=BB0_11 Depth=2
	...
	vpcmpgtd	%zmm4, %zmm8, %k1
	vpcmpgtd	%zmm5, %zmm8, %k2
	vpcmpgtd	%zmm6, %zmm8, %k3
	vpcmpgtd	%zmm7, %zmm8, %k4
	vmovupd	192(%rdx,%r9,8), %zmm8 {%k4} {z}
	vmovupd	128(%rdx,%r9,8), %zmm9 {%k3} {z}
	vmovupd	64(%rdx,%r9,8), %zmm10 {%k2} {z}
	vmovupd	(%rdx,%r9,8), %zmm11 {%k1} {z}
	vmulpd	%zmm2, %zmm11, %zmm11
	vmulpd	%zmm2, %zmm10, %zmm10
	vmulpd	%zmm2, %zmm9, %zmm9
	vmulpd	%zmm2, %zmm8, %zmm8
	vmovupd	%zmm8, 192(%rdx,%r9,8) {%k4}
	vmovupd	%zmm9, 128(%rdx,%r9,8) {%k3}
	vmovupd	%zmm10, 64(%rdx,%r9,8) {%k2}
	vmovupd	%zmm11, (%rdx,%r9,8) {%k1}
	incq	%r9
	addq	$-32, %r8
	cmpq	%r9, %rsi
	je	.LBB0_15
...
# %bb.12:                               #   in Loop: Header=BB0_11 Depth=2
	vmulpd	64(%rdx,%r9,8), %zmm2, %zmm8
	vmulpd	(%rdx,%r9,8), %zmm2, %zmm9
	vmulpd	192(%rdx,%r9,8), %zmm2, %zmm10
	vmulpd	128(%rdx,%r9,8), %zmm2, %zmm11
	vmovupd	%zmm11, 128(%rdx,%r9,8)
	vmovupd	%zmm10, 192(%rdx,%r9,8)
	vmovupd	%zmm9, (%rdx,%r9,8)
	vmovupd	%zmm8, 64(%rdx,%r9,8)
	incq	%r9
	addq	$-32, %r8
	cmpq	%r9, %rsi
	jne	.LBB0_11
...
.LBB0_16:                               #   Parent Loop BB0_10 Depth=1
	...
	movq	%r8, %r9
	shlq	$5, %r9
	cmpq	$968, %r9                       # imm = 0x3C8
	ja	.LBB0_19
# %bb.17:                               # %.split.us.i.preheader
                                        #   in Loop: Header=BB0_16 Depth=2
	leaq	(%r8,%rdi), %r9
	vbroadcastsd	(%r14,%r9,8), %zmm8
	vbroadcastsd	(%r15,%r9,8), %zmm9
	movq	%r8, %r9
	xorl	%r10d, %r10d
	.p2align	4, 0x90
.LBB0_18:                               # %.split.us.i
	...
	vpbroadcastq	%r9, %zmm10
	vpsllq	$3, %zmm10, %zmm10
	vpaddq	%zmm10, %zmm0, %zmm11
	vxorpd	%xmm12, %xmm12, %xmm12
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm11), %zmm12 {%k1}
	vxorpd	%xmm13, %xmm13, %xmm13
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm11), %zmm13 {%k1}
	vpxor	%xmm14, %xmm14, %xmm14
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm11), %zmm14 {%k1}
	vpxor	%xmm15, %xmm15, %xmm15
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm11), %zmm15 {%k1}
	vpaddq	%zmm10, %zmm1, %zmm10
	vxorpd	%xmm11, %xmm11, %xmm11
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm10), %zmm11 {%k1}
	vpxord	%zmm16, %zmm16, %zmm16
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm10), %zmm16 {%k1}
	vpxord	%zmm17, %zmm17, %zmm17
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm10), %zmm17 {%k1}
	vpxord	%zmm18, %zmm18, %zmm18
	kxnorw	%k0, %k0, %k1
	vgatherqpd	(,%zmm10), %zmm18 {%k1}
	vmulpd	%zmm3, %zmm15, %zmm10
	vmulpd	%zmm3, %zmm14, %zmm14
	vmulpd	%zmm3, %zmm13, %zmm13
	vmulpd	%zmm3, %zmm12, %zmm12
	vmulpd	%zmm12, %zmm9, %zmm12
	vmulpd	%zmm13, %zmm9, %zmm13
	vmulpd	%zmm14, %zmm9, %zmm14
	vmulpd	%zmm10, %zmm9, %zmm10
	vmulpd	%zmm3, %zmm18, %zmm15
	vmulpd	%zmm3, %zmm17, %zmm17
	vmulpd	%zmm3, %zmm16, %zmm16
	vmulpd	%zmm3, %zmm11, %zmm11
	vfmadd213pd	%zmm10, %zmm8, %zmm11   # zmm11 = (zmm8 * zmm11) + zmm10
	vfmadd213pd	%zmm14, %zmm8, %zmm16   # zmm16 = (zmm8 * zmm16) + zmm14
	vfmadd213pd	%zmm13, %zmm8, %zmm17   # zmm17 = (zmm8 * zmm17) + zmm13
	vfmadd213pd	%zmm12, %zmm8, %zmm15   # zmm15 = (zmm8 * zmm15) + zmm12
	vaddpd	192(%rdx,%r10,8), %zmm15, %zmm10
	vaddpd	64(%rdx,%r10,8), %zmm17, %zmm12
	vaddpd	(%rdx,%r10,8), %zmm16, %zmm13
	vaddpd	128(%rdx,%r10,8), %zmm11, %zmm11
	vmovupd	%zmm11, 128(%rdx,%r10,8)
	vmovupd	%zmm13, (%rdx,%r10,8)
	vmovupd	%zmm12, 64(%rdx,%r10,8)
	vmovupd	%zmm10, 192(%rdx,%r10,8)
	incq	%r10
