...
.LBB0_17:                               # %for.body11.i
	...
	vmulsd	-48(%r13,%r15), %xmm1, %xmm6
	vmulsd	-48(%r9,%r15), %xmm6, %xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vfmadd231sd	-48(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	-40(%r11,%r15), %xmm1, %xmm4
	vmulsd	-40(%r13,%r15), %xmm1, %xmm5
	vmulsd	-40(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-40(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-32(%r11,%r15), %xmm1, %xmm4
	vmulsd	-32(%r13,%r15), %xmm1, %xmm6
	vmulsd	-32(%r9,%r15), %xmm6, %xmm6
	vfmadd231sd	-32(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vaddsd	%xmm6, %xmm3, %xmm3
