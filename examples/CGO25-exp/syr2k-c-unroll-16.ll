...
.LBB0_17:                               # %for.body11.i
	...
	vmulsd	-120(%r11,%r15), %xmm1, %xmm4
	vmulsd	-120(%r13,%r15), %xmm1, %xmm5
	vmulsd	-120(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-120(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vaddsd	%xmm5, %xmm3, %xmm3
	vmulsd	-112(%r11,%r15), %xmm1, %xmm4
	vmulsd	-112(%r13,%r15), %xmm1, %xmm5
	vmulsd	-112(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-112(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-104(%r11,%r15), %xmm1, %xmm4
	vmulsd	-104(%r13,%r15), %xmm1, %xmm6
	vmulsd	-104(%r9,%r15), %xmm6, %xmm6
	vfmadd231sd	-104(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	-96(%r11,%r15), %xmm1, %xmm4
	vmulsd	-96(%r13,%r15), %xmm1, %xmm5
	vmulsd	-96(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-96(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-88(%r11,%r15), %xmm1, %xmm4
	vmulsd	-88(%r13,%r15), %xmm1, %xmm6
	vmulsd	-88(%r9,%r15), %xmm6, %xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vfmadd231sd	-88(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	-80(%r11,%r15), %xmm1, %xmm4
	vmulsd	-80(%r13,%r15), %xmm1, %xmm5
	vmulsd	-80(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-80(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-72(%r11,%r15), %xmm1, %xmm4
	vmulsd	-72(%r13,%r15), %xmm1, %xmm6
	vmulsd	-72(%r9,%r15), %xmm6, %xmm6
	vfmadd231sd	-72(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	-64(%r11,%r15), %xmm1, %xmm4
	vmulsd	-64(%r13,%r15), %xmm1, %xmm5
	vmulsd	-64(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-64(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vaddsd	%xmm5, %xmm3, %xmm3
	cmpq	$7936, %r15                     # imm = 0x1F00
	je	.LBB0_19
# %bb.18:                               # %for.body11.8.i
                                        #   in Loop: Header=BB0_17 Depth=3
	vmulsd	-56(%r11,%r15), %xmm1, %xmm4
	vmulsd	-56(%r13,%r15), %xmm1, %xmm5
	vmulsd	-56(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-56(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vaddsd	%xmm5, %xmm3, %xmm3
	vmulsd	-48(%r11,%r15), %xmm1, %xmm4
	vmulsd	-48(%r13,%r15), %xmm1, %xmm5
	vmulsd	-48(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-48(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-40(%r11,%r15), %xmm1, %xmm4
	vmulsd	-40(%r13,%r15), %xmm1, %xmm6
	vmulsd	-40(%r9,%r15), %xmm6, %xmm6
	vfmadd231sd	-40(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	-32(%r11,%r15), %xmm1, %xmm4
	vmulsd	-32(%r13,%r15), %xmm1, %xmm5
	vmulsd	-32(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-32(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-24(%r11,%r15), %xmm1, %xmm4
	vmulsd	-24(%r13,%r15), %xmm1, %xmm6
	vmulsd	-24(%r9,%r15), %xmm6, %xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vfmadd231sd	-24(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	-16(%r11,%r15), %xmm1, %xmm4
	vmulsd	-16(%r13,%r15), %xmm1, %xmm5
	vmulsd	-16(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	-16(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vmulsd	-8(%r11,%r15), %xmm1, %xmm4
	vmulsd	-8(%r13,%r15), %xmm1, %xmm6
	vmulsd	-8(%r9,%r15), %xmm6, %xmm6
	vfmadd231sd	-8(%r8,%r15), %xmm4, %xmm6 # xmm6 = (xmm4 * mem) + xmm6
	vaddsd	%xmm5, %xmm3, %xmm3
	vaddsd	%xmm6, %xmm3, %xmm3
	vmulsd	(%r11,%r15), %xmm1, %xmm4
	vmulsd	(%r13,%r15), %xmm1, %xmm5
	vmulsd	(%r9,%r15), %xmm5, %xmm5
	vfmadd231sd	(%r8,%r15), %xmm4, %xmm5 # xmm5 = (xmm4 * mem) + xmm5
	vaddsd	%xmm5, %xmm3, %xmm3
	subq	$-128, %r15
	jmp	.LBB0_17
.LBB0_21:                               # %kernel_syr2k.exit
	movq	%rbx, %rdi
	vzeroupper
	callq	free@PLT
