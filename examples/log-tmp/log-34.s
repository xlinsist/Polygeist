	...
	.p2align	3, 0x0                          # -- Begin function matmul_broadcast_mask_affineload_34
.LCPI0_0:
	.quad	8680820740569200761             # 0x7878787878787879
	.text
	.globl	matmul_broadcast_mask_affineload_34
	.p2align	2
	.type	matmul_broadcast_mask_affineload_34,@function
matmul_broadcast_mask_affineload_34:    # @matmul_broadcast_mask_affineload_34
	.cfi_startproc
# %bb.0:
	addi	sp, sp, -64
...
.LBB0_18:
	...
	ret
.Lfunc_end0:
	.size	matmul_broadcast_mask_affineload_34, .Lfunc_end0-matmul_broadcast_mask_affineload_34
	.cfi_endproc
                                        # -- End function
	.globl	_mlir_ciface_matmul_broadcast_mask_affineload_34 # -- Begin function _mlir_ciface_matmul_broadcast_mask_affineload_34
	.p2align	2
	.type	_mlir_ciface_matmul_broadcast_mask_affineload_34,@function
_mlir_ciface_matmul_broadcast_mask_affineload_34: # @_mlir_ciface_matmul_broadcast_mask_affineload_34
	.cfi_startproc
# %bb.0:
	addi	sp, sp, -112
	...
	mv	a1, t0
	mv	a2, t1
	call	matmul_broadcast_mask_affineload_34@plt
	ld	ra, 104(sp)                     # 8-byte Folded Reload
	addi	sp, sp, 112
	ret
.Lfunc_end1:
	.size	_mlir_ciface_matmul_broadcast_mask_affineload_34, .Lfunc_end1-_mlir_ciface_matmul_broadcast_mask_affineload_34
	.cfi_endproc
                                        # -- End function
