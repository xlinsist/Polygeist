	...
	.p2align	3, 0x0                          # -- Begin function matmul_broadcast_mask_affineload_36
.LCPI0_0:
	.quad	1024819115206086201             # 0xe38e38e38e38e39
	.text
	.globl	matmul_broadcast_mask_affineload_36
	.p2align	2
	.type	matmul_broadcast_mask_affineload_36,@function
matmul_broadcast_mask_affineload_36:    # @matmul_broadcast_mask_affineload_36
	.cfi_startproc
# %bb.0:
	addi	sp, sp, -64
...
.LBB0_18:
	...
	ret
.Lfunc_end0:
	.size	matmul_broadcast_mask_affineload_36, .Lfunc_end0-matmul_broadcast_mask_affineload_36
	.cfi_endproc
                                        # -- End function
	.globl	_mlir_ciface_matmul_broadcast_mask_affineload_36 # -- Begin function _mlir_ciface_matmul_broadcast_mask_affineload_36
	.p2align	2
	.type	_mlir_ciface_matmul_broadcast_mask_affineload_36,@function
_mlir_ciface_matmul_broadcast_mask_affineload_36: # @_mlir_ciface_matmul_broadcast_mask_affineload_36
	.cfi_startproc
# %bb.0:
	addi	sp, sp, -112
	...
	mv	a1, t0
	mv	a2, t1
	call	matmul_broadcast_mask_affineload_36@plt
	ld	ra, 104(sp)                     # 8-byte Folded Reload
	addi	sp, sp, 112
	ret
.Lfunc_end1:
	.size	_mlir_ciface_matmul_broadcast_mask_affineload_36, .Lfunc_end1-_mlir_ciface_matmul_broadcast_mask_affineload_36
	.cfi_endproc
                                        # -- End function
